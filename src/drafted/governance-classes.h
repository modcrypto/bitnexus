 ...
 *
 *   // network
 *   CBitcoinNodeNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.bitcoinnode.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CBitcoinNodeNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CBitcoinNodeNetwork(UniValue objIn)
    {
...
// // can be under: BitcoinNodeNetwork
// //   -- signature requirements : Key1(User)
// class CBitcoinNodeNetworkVariable : public CGovernanceObject
// {
// private:
...
//     //     return (IsType() == BitcoinNodeNetwork);
//     // }

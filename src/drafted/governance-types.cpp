...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "BitNexusNetwork") type = BitNexusNetwork;
    if(strType == "BitNexusNetworkVariable") type = BitNexusNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == BitNexusNetwork) s = "BitNexusNetwork";
    if(type == BitNexusNetworkVariable) s = "BitNexusNetworkVariable";

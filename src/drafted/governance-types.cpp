...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "BitcoinNodeNetwork") type = BitcoinNodeNetwork;
    if(strType == "BitcoinNodeNetworkVariable") type = BitcoinNodeNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == BitcoinNodeNetwork) s = "BitcoinNodeNetwork";
    if(type == BitcoinNodeNetworkVariable) s = "BitcoinNodeNetworkVariable";

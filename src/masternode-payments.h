...
public:
    ...
    bool IsTransactionValid(const CTransaction& txNew, CAmount blockReward);
...
public:
    ...
    bool IsTransactionValid(const CTransaction& txNew, int nBlockHeight, CAmount blockReward);

/* src/config/bitcoinnode-config.h.  Generated from bitcoinnode-config.h.in by configure.  */
/* src/config/bitcoinnode-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef BITCOINNODE_CONFIG_H

#define BITCOINNODE_CONFIG_H
...
#define PACKAGE_BUGREPORT "https://github.com/bitcoinnodecoin/bitcoinnode/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "BitcoinNode Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "BitcoinNode Core 0.12.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "bitcoinnodecore"

...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("BitcoinNode Core bitcoinnode-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  bitcoinnode-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bitcoinnode transaction") + "\n" +
              "  bitcoinnode-tx [options] -create [commands]   " + _("Create hex-encoded bitcoinnode transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded bitcoinnode transaction

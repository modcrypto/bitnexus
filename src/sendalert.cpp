...
2. run bitnexusd with -printalert or -sendalert like this:
   /path/to/bitnexusd -printalert
...
void ThreadSendAlert()
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.bitnexus.org";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/BitNexus Core:0.12.0.58/"));

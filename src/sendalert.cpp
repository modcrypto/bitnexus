...
2. run bitcoinnoded with -printalert or -sendalert like this:
   /path/to/bitcoinnoded -printalert
...
void ThreadSendAlert()
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.bitcoinnode.org";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/BitcoinNode Core:0.12.0.58/"));

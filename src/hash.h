...
#include "crypto/x16s/sph_hamsi.h"
#include "crypto/x16s/sph_fugue.h"
#include "crypto/x16s/sph_shabal.h"
#include "crypto/x16s/sph_whirlpool.h"
extern "C" {
#include "crypto/x16s/sph_sha2.h"
}
#include <vector>

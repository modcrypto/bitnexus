...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("BitNexus Core bitnexus-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  bitnexus-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bitnexus transaction") + "\n" +
              "  bitnexus-tx [options] -create [commands]   " + _("Create hex-encoded bitnexus transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded bitnexus transaction

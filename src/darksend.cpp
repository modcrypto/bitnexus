...
{
    if(fLiteMode) return; // ignore all BitcoinNode related functionality
...
/*
    ...
    allow endless transaction that would bloat BitcoinNode and make it unusable. To
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("bitcoinnode-privatesend");

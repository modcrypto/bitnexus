    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("BitNexus Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About BitNexus Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  bitnexus-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the BitNexus in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 BTNX, 0.1 BTNX, 1 BTNX and 10 BTNX -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://bitnexuscoin.atlassian.net/wiki/display/DOC/PrivateSend\">https://bitnexuscoin.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("BitNexus Core is shutting down...") + "<br /><br />" +

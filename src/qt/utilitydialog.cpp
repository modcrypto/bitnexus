    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("BitcoinNode Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About BitcoinNode Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  bitcoinnode-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the BitcoinNode in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 BTN, 0.1 BTN, 1 BTN and 10 BTN -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://bitcoinnodecoin.atlassian.net/wiki/display/DOC/PrivateSend\">https://bitcoinnodecoin.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("BitcoinNode Core is shutting down...") + "<br /><br />" +

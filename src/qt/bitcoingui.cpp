    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("BitcoinNode Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a BitcoinNode address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and bitcoinnode: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About BitcoinNode Core"), this);
    aboutAction->setStatusTip(tr("Show information about BitcoinNode Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for BitcoinNode Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your BitcoinNode addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified BitcoinNode addresses"));
    ...
    openAction->setStatusTip(tr("Open a bitcoinnode: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the BitcoinNode Core help message to get a list with possible BitcoinNode Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("BitcoinNode Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to BitcoinNode network", "", count));
}
...
{
    QString strTitle = tr("BitcoinNode Core"); // default title
    ...
    // Append title to "BitcoinNode Core - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;

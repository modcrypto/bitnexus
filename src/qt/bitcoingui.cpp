    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("BitNexus Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a BitNexus address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and bitnexus: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About BitNexus Core"), this);
    aboutAction->setStatusTip(tr("Show information about BitNexus Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for BitNexus Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your BitNexus addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified BitNexus addresses"));
    ...
    openAction->setStatusTip(tr("Open a bitnexus: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the BitNexus Core help message to get a list with possible BitNexus Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("BitNexus Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to BitNexus network", "", count));
}
...
{
    QString strTitle = tr("BitNexus Core"); // default title

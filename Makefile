...
pkgdatadir = $(datadir)/bitcoinnodecore
pkgincludedir = $(includedir)/bitcoinnodecore
pkglibdir = $(libdir)/bitcoinnodecore
pkglibexecdir = $(libexecdir)/bitcoinnodecore
...
DIST_COMMON = $(srcdir)/Makefile.in $(srcdir)/Makefile.am \
	...
	$(top_srcdir)/src/config/bitcoinnode-config.h.in \
...
CONFIG_HEADER = $(top_builddir)/src/config/bitcoinnode-config.h
...
ACLOCAL = ${SHELL} "/home/root/Desktop/Parallels Shared Folders/zeroOne/gobyte/build-aux/missing" aclocal-1.14
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
AUTOCONF = ${SHELL} "/home/root/Desktop/Parallels Shared Folders/zeroOne/gobyte/build-aux/missing" autoconf
AUTOHEADER = ${SHELL} "/home/root/Desktop/Parallels Shared Folders/zeroOne/gobyte/build-aux/missing" autoheader
AUTOMAKE = ${SHELL} "/home/root/Desktop/Parallels Shared Folders/zeroOne/gobyte/build-aux/missing" automake-1.14
AWK = mawk
BDB_CPPFLAGS = 
...
MAINT = 
MAKEINFO = ${SHELL} "/home/root/Desktop/Parallels Shared Folders/zeroOne/gobyte/build-aux/missing" makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
MINIUPNPC_LIBS = 
...
OTOOL = 
OTOOL64 = 
PACKAGE = bitcoinnodecore
PACKAGE_BUGREPORT = https://github.com/bitcoinnodecoin/bitcoinnode/issues
PACKAGE_NAME = BitcoinNode Core
PACKAGE_STRING = BitcoinNode Core 0.12.1
PACKAGE_TARNAME = bitcoinnodecore
PACKAGE_URL = 
...
ZMQ_CFLAGS =  
ZMQ_LIBS = -lzmq  
abs_builddir = /home/root/Desktop/Parallels Shared Folders/zeroOne/gobyte
abs_srcdir = /home/root/Desktop/Parallels Shared Folders/zeroOne/gobyte
abs_top_builddir = /home/root/Desktop/Parallels Shared Folders/zeroOne/gobyte
abs_top_srcdir = /home/root/Desktop/Parallels Shared Folders/zeroOne/gobyte
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} '/home/root/Desktop/Parallels Shared Folders/zeroOne/gobyte/build-aux/install-sh'
...
BITCOIND_BIN = $(top_builddir)/src/bitcoinnoded$(EXEEXT)
BITCOIN_QT_BIN = $(top_builddir)/src/qt/bitcoinnode-qt$(EXEEXT)
BITCOIN_CLI_BIN = $(top_builddir)/src/bitcoinnode-cli$(EXEEXT)
BITCOIN_WIN_INSTALLER = $(PACKAGE)-$(PACKAGE_VERSION)-win$(WINDOWS_BITS)-setup$(EXEEXT)
OSX_APP = BitcoinNode-Qt.app
OSX_DMG = BitcoinNode-Core.dmg
...
COVERAGE_INFO = baseline_filtered_combined.info baseline.info block_test.info \
  leveldb_baseline.info test_bitcoinnode_filtered.info total_coverage.info \
  baseline_filtered.info block_test_filtered.info rpc_test.info rpc_test_filtered.info \
  leveldb_baseline_filtered.info test_bitcoinnode_coverage.info test_bitcoinnode.info

OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  $(OSX_APP)/Contents/Resources/bitcoin.icns $(OSX_APP)/Contents/Info.plist \
  $(OSX_APP)/Contents/MacOS/BitcoinNode-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
src/config/bitcoinnode-config.h: src/config/stamp-h1
	@test -f $@ || rm -f src/config/stamp-h1
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) src/config/stamp-h1

src/config/stamp-h1: $(top_srcdir)/src/config/bitcoinnode-config.h.in $(top_builddir)/config.status
	@rm -f src/config/stamp-h1
	cd $(top_builddir) && $(SHELL) ./config.status src/config/bitcoinnode-config.h
$(top_srcdir)/src/config/bitcoinnode-config.h.in:  $(am__configure_deps) 
	($(am__cd) $(top_srcdir) && $(AUTOHEADER))
	rm -f src/config/stamp-h1
	touch $@

distclean-hdr:
	-rm -f src/config/bitcoinnode-config.h src/config/stamp-h1
...
$(OSX_APP)/Contents/MacOS/BitcoinNode-Qt: $(BITCOIN_QT_BIN)
	$(MKDIR_P) $(@D)
...
#	$(OSX_DEPLOY_SCRIPT) $(OSX_APP) -add-qt-tr $(OSX_QT_TRANSLATIONS) -translations-dir=$(QT_TRANSLATION_DIR) -dmg   -verbose 3 -add-resources contrib/macdeploy/libboost_system-mt.dylib
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/BitcoinNode-Qt

$(OSX_DMG): $(APP_DIST_EXTRAS)
	$(GENISOIMAGE) -no-cache-inodes -D -l -probe -V "BitcoinNode-Core" -no-pad -r -dir-mode 0755 -apple -o $@ dist
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/BitcoinNode-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
...
#test_bitcoinnode.info: baseline_filtered_combined.info
#	$(MAKE) -C src/ check
#	$(LCOV) -c -d $(abs_builddir)/src -t test_bitcoinnode -o $@
#	$(LCOV) -z -d $(abs_builddir)/src
#	$(LCOV) -z -d $(abs_builddir)/src/leveldb

#test_bitcoinnode_filtered.info: test_bitcoinnode.info
#	$(LCOV) -r $< "/usr/include/*" -o $@

#block_test.info: test_bitcoinnode_filtered.info
#	$(MKDIR_P) qa/tmp
...
#rpc_test.info: test_bitcoinnode_filtered.info
...
#test_bitcoinnode_coverage.info: baseline_filtered_combined.info test_bitcoinnode_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_bitcoinnode_filtered.info -o $@

#total_coverage.info: baseline_filtered_combined.info test_bitcoinnode_filtered.info block_test_filtered.info rpc_test_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_bitcoinnode_filtered.info -a block_test_filtered.info -a rpc_test_filtered.info -o $@ | $(GREP) "\%" | $(AWK) '{ print substr($$3,2,50) "/" $$5 }' > coverage_percent.txt

#test_bitcoinnode.coverage/.dirstamp:  test_bitcoinnode_coverage.info
#	$(GENHTML) -s $< -o $(@D)
#	@touch $@
...
#cov: test_bitcoinnode.coverage/.dirstamp total.coverage/.dirstamp

# BitcoinNode: disable the test until upstream switches from convoluted comparison tool
...
clean-local:
	rm -rf coverage_percent.txt test_bitcoinnode.coverage/ total.coverage/ qa/tmp/ cache/ $(OSX_APP)

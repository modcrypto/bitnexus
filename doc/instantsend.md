...
This mechanism has been integrated into Bitcore-Node-BitcoinNode which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/bitcoinnodecoin/insight-api-bitcoinnode#web-socket-api](https://github.com/bitcoinnodecoin/insight-api-bitcoinnode#web-socket-api) 
* API: [https://github.com/bitcoinnodecoin/insight-api-bitcoinnode#instantsend-transactions](https://github.com/bitcoinnodecoin/insight-api-bitcoinnode#instantsend-transactions) 
...
By default, the BitcoinNode Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the BitcoinNode Core daemon:

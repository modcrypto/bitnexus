...
BitcoinNode now supports full decentralized budgets that are paid directly from the blockchain via superblocks once per month.
...
Format: ```mngovernance prepare proposal-name url payment-count block-start bitcoinnode-address monthly-payment-bitcoinnode```
...
Format: ```mngovernance submit proposal-name url payment-count block-start bitcoinnode-address monthly-payment-bitcoinnode fee-tx```
...
The following RPC commands are supported:
 ...
 - mngovernance "command"... ( "passphrase" )
  ...
  - vote               - Vote on a proposal by single masternode (using bitcoinnode.conf setup)

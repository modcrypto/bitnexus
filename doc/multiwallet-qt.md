...
Only requiring some minor changes is bitcoinnode.cpp.
...
Changes to bitcoinnode.cpp
----------------------
bitcoinnode.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for

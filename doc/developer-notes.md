...
BitcoinNode Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as BitcoinNode Core, where everyone uses
...
pay attention to for reviewers of BitcoinNode Core code.

General BitcoinNode Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: BitcoinNode Core uses tinyformat, which is type safe. Leave them out to avoid confusion
